...
<div id="main">
	...
	int i = 0;
	while(rs.next()){
		recitem[i][0] = rs.getString("Number"); //몇번?
		recitem[i][1] = rs.getString("Title"); //제목
		recitem[i][2] = rs.getString("Area"); //평수
		recitem[i][3] = rs.getString("Price"); //가격
		recitem[i][3] = rs.getString("Location"); //가격
		i++;
	}
	//out.println(pstmt);
	int recnum = i;
